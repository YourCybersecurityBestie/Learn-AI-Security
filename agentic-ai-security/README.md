# Security in the Agentic AI Space — Core Microsoft Documentation

> Curated by **Venicia Solomons** — a single-pane reference for the official Microsoft documentation, frameworks, and engineering work that defines how we secure, govern, and defend with autonomous AI agents.
...
Microsoft frames the problem across **three pillars**, anchored on the [Zero Trust adoption framework](https://learn.microsoft.com/en-us/security/zero-trust/adopt/zero-trust-adoption-overview):

| Pillar | What it means |
|---|---|
| **Security FOR AI** | Securing how your organisation builds, deploys, and uses AI — models, agents, data, identities, prompts |
| **AI FOR Security** | Using AI as a force multiplier for defenders — Security Copilot, agentic SOC, AI in Defender and Entra |
...
The rest of this document is the official Microsoft documentation set for each, plus the newest agentic-specific work: **Microsoft Entra Agent ID**, **Microsoft Agent 365**, **Defender for AI**, **Project MDASH**, and **Project Glasswing**.

All links validated against learn.microsoft.com / microsoft.com.

---

## Foundation — Zero Trust & the Security-for-AI library

- [Zero Trust adoption framework — overview](https://learn.microsoft.com/en-us/security/zero-trust/adopt/zero-trust-adoption-overview) — the parent framework everything below maps onto
- [Zero Trust overview](https://learn.microsoft.com/en-us/security/zero-trust/zero-trust-overview)
- [Microsoft Security for AI — library home](https://learn.microsoft.com/en-us/security/security-for-ai) — the canonical landing page
...
- [CAF — AI agents: governance & security across the organisation](https://learn.microsoft.com/en-us/azure/cloud-adoption-framework/ai-agents/governance-security-across-organization) — **the agent-specific governance baseline**
...
### Agentic identity & access — Microsoft Entra Agent ID
...
- [Defender + Agent 365](https://learn.microsoft.com/en-us/microsoft-agent-365/leadership/defender-agent-365)
- [Entra + Agent 365](https://learn.microsoft.com/en-us/microsoft-agent-365/leadership/entra-agent-365)
...
- [Agent 365 security (Security-for-AI library)](https://learn.microsoft.com/en-us/security/security-for-ai/agent-365-security)
...
### Zero Trust overlay for Copilots & M365
...
### Unified SecOps + Copilot in Defender / Entra
...
Adversaries are using AI too — for phishing at scale, malware variant generation, deepfakes, and agentic recon. This pillar covers Microsoft's intelligence work, detection content, and the defensive AI Microsoft itself runs against attackers.
...
- [Microsoft Digital Defense Report](https://www.microsoft.com/en-us/security/business/microsoft-digital-defense-report) — annual report; sections on AI-enabled threats and influence operations

---

## Newer agentic work — Project MDASH

**Project MDASH** (Multi-model Agentic Scanning Harness) is Microsoft's autonomous vulnerability-discovery agent, built by the Autonomous Code Security team led by VP Taesoo Kim.

What it is, in short:
- 100+ specialised AI agents orchestrated to find, triage, and validate security bugs at scale
- Posted **88.45% on the CyberGym benchmark** — top of the public leaderboard
- Found **16 CVEs that shipped in the 12 May 2026 Patch Tuesday** release
- Hit **96% recall on `clfs.sys`** and **100% recall on `tcpip.sys`** against the MSRC historical backlog
- Now in **private preview** for partners
...
## Newer agentic work — Project Glasswing

**Project Glasswing** is an Anthropic-led cross-industry initiative on the safe use of agentic AI for offensive-security research — testing Claude Mythos Preview for autonomous vulnerability discovery. Microsoft is a participant alongside AWS, Apple, Broadcom, Cisco, CrowdStrike, Google, JPMorganChase, Linux Foundation, NVIDIA, and Palo Alto Networks.

- [Anthropic — Project Glasswing](https://www.anthropic.com/glasswing)
- [MSRC blog — Strengthening secure software at global scale: how MSRC is evolving with AI (Apr 2026)](https://www.microsoft.com/en-us/msrc/blog/2026/04/strengthening-secure-software-global-scale-how-msrc-is-evolving-with-ai) — Microsoft's role in Glasswing
...
1. **Start with the Foundation** — Zero Trust adoption + the Security-for-AI library home. Everything else hangs off these.
...
*Maintained by Venicia Solomons. Spot a broken link or want a section added? Open an issue or PR.*
